...
/**
*itos- converts an interger to a string
*@digits: interger to be converted
*Return: string
*/
...
* @str: string to be chec for errors
* Return: 0
*/
...
/**
* fprintstrs- string printer
* @fd: file descriptor
* @str: string to be printed
* @... : last arg should have NULL
* Return: 0
*/
...
* Return: address in the first appearance of the character in string
*/
